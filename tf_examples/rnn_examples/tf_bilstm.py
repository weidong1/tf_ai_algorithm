...
'''
@file: tf_bilstm.py
@desc: 来源 https://github.com/aymericdamien/TensorFlow-Examples/
'''
...
weights = {
    ...
    'out': tf.Variable(tf.random_normal([2*n_hidden, n_classes]))  # 注意是 biLSTM
}
biases = {
...
def BiRNN(x, weights, biases):
    ...
    # Current data input shape: (batch_size, n_steps, n_input)  也就是 [batch_size,timestep,embedding_dim]
    ...
    try:
        #  inputs_embedded为输入的tensor，[batch_szie, max_time, depth]
